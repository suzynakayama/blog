...
import a11y-light from 'react-syntax-highlighter/dist/esm/styles/hljs/a11y-light';
...
![Photo by Alice Pasqual on Unsplash](../public/images/articles/donuts.jpeg)
...
<SyntaxHighlighter language="javascript" style={a11y-light} >
...
![My “beautiful” explanation of Log!]()
